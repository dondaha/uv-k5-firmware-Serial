...
ifeq ($(ENABLE_SERIAL_RC),1)
	CFLAGS  += -DENABLE_SERIAL_RC
endif
...
serial:
	$(RM) *.bin
	$(MAKE) build ENABLE_CHINESE_FULL=0 ENABLE_ENGLISH=1 ENABLE_DOPPLER=0 ENABLE_SPECTRUM=0 ENABLE_FMRADIO=0 ENABLE_SERIAL_RC=1 ENABLE_FLASHLIGHT=0
